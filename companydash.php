    ...
    <div class="content">
                ...
                <div>
                    ...
                    ?>
                        ...
                        <td><button type="submit" class="but" name="approve" onclick="return confirm('Are you sure you want to delete this car?')"><a href="companydeletecar.php?id=<?php echo $res['CAR_ID']?>">DELETE CAR</a></button></td>
