...
input[type="text"], input[type="number"], input[type="file"], input[type="brand"] {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="main">
        ...
        <form id="register"  action="companyupload.php" method="POST" enctype="multipart/form-data"> 
            ...
            id="name" placeholder="Enter Car Model" required>
            <br><br>
            <label>License Plate Number (no spaces) : </label>
            <br>
            <input type ="text" name="plateno"
            id="name" placeholder="KXX123X" required>
            <br><br>
            <label>Description : </label>
            <br>
            <input type ="text" name="description"
            id="name" placeholder="Enter Car Description" required>
            <br><br>
            ...
            <br>
            <?php
            // Assuming you already have a database connection and a session started
            $value = $_SESSION['email'];
            $sql = "SELECT cname FROM company WHERE EMAIL='$value'";
            ...
            <input type="text" name="cname"
                  id="name" placeholder="Enter Name of the Company Renting"
